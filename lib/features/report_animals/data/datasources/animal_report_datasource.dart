...
abstract interface class IAnimalReportLocalDataSource {
  ...
  Future<AnimalReportHiveModel> createAnimalReport(AnimalReportHiveModel report);
  Future<AnimalReportHiveModel?> updateReportStatus(String reportId, String newStatus);
...
abstract interface class IAnimalReportRemoteDataSource {
  ...
  Future<AnimalReportApiModel> createAnimalReport(AnimalReportApiModel report);
  Future<AnimalReportApiModel?> updateReportStatus(String reportId, String newStatus);
  Future<bool> deleteReport(String reportId);
  Future<String> uploadPhoto(File photo);
}
